      ...
      <main class="form-container">
        ...
        <form class="form-content" id="trantibumForm">
            ...
            <div class="form-group">
                ...
                <textarea id="nama" class="input-field-laporan-singkat" placeholder="Tuliskan Laporan Anda Disini"></textarea>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="select-wrapper">
              <select id="unsur-terlibat" class="input-field" placeholder="Pilih Unsur Terlibat">
                <option value="">Sikon 1</option>
                <option value="">Sikon 2</option>
                <option value="">Sikon 3</option>
                <option value="">Sikon 4</option>
              </select>
            </div>
          </div>
        ...
        <footer class="form-footer">
            <a href="form-laporan2" type="button" class="btn-back" id="backButton">
                Kembali
            </a>
            <a href="form-laporan4" class="btn-next" id="nextButton">
                Selanjutnya
            </a>
        </footer>
      </main>
