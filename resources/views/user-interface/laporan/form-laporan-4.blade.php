      ...
      <main class="form-container">
        ...
        <form class="form-content" id="trantibumForm">
            ...
            <div class="form-group">
                ...
                <textarea id="nama" class="input-field-catatan" placeholder="Tuliskan Laporan Anda Disini"></textarea>
            </div>

        </form>

        <footer class="form-footer">
            <a href="form-laporan3" type="button" class="btn-back" id="backButton">
                Kembali
            </a>
            <a href="success-form" class="btn-next" id="nextButton" style="background-color:#40df68; ">
                Selanjutnya
            </a>
        </footer>
      </main>
