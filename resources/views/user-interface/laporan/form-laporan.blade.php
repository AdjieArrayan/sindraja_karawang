...
@section('content')
      ...
      <main class="form-container">
        ...
        <form class="form-content" id="trantibumForm">
          ...
          <div class="form-group">
            <label for="regu" class="label">Regu Pelapor</label>
            <div class="select-wrapper">
              <select id="regu" class="input-field" placeholder="Pilih Regu Pelapor">
                <option value="">Regu 1</option>
                <option value="">Regu 2</option>
                <option value="">Regu 3</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="select-wrapper">
              <select id="kegiatan" class="input-field" placeholder="Pilih Jenis Kegiatan">
          ...
          <div class="form-group">
            ...
            <div class="date-wrapper">
              <input type="date" id="tanggal" class="hidden-date-input" placeholder="Pilih Tanggal"/>
        ...
        <footer class="form-footer">
            <a href="user-main" type="button" class="btn-back" id="backButton">
                Kembali</a>
            <a href="form-laporan2" class="btn-next" id="nextButton">
                Selanjutnya
            </a>
        </footer>
      </main>
    ...
    <script>
        ...
        document.getElementById("tanggal-display").value = this.value;
        });
