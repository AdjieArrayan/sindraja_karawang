  ...
  <body>
    <main class="main-container min-vh-100 position-relative overflow-hidden">
      <header class="logo-section d-flex align-items-center position-relative">
        <img src="{{asset('style/assets/image/hero_img/logo_karawang.png') }}" alt="Logo 1" class="logo-img-1"/>
        <img src="{{asset('style/assets/image/hero_img/polisi_pamong_praja_logo.png') }}" alt="Logo 2" class="logo-img-2"/>
      ...
      <section class="content-section position-relative">
        ...
        <a href="login-form" class="login-button btn d-flex justify-content-center" type="button">LOGIN DISINI</a>
      </section>

      <img src="{{asset('style/assets/image/hero_img/hero_logo.png') }}" alt="SINDRAJA" class="sindraja-img"/>

      <div class="footer-overlay position-absolute w-100">
        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-lg-6 text-white">
              <p class="footer-left m-0">Satpol PP Profesional, Tangguh, dan Terdepan</p>
            </div>
            <nav class="col-lg-6">
              <div class="footer-right d-flex justify-content-lg-end">
                ...
                <a href="https://satpol.ppkrwkab.go.id" class="contact-item text-decoration-none" aria-label="Website">
                  ...
                  <span>satpol.ppkrwkab.go.id</span>
                </a>
              </div>
            </nav>
          </div>
